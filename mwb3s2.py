...
# spike to see what happens with simple mistletoe replacement
# markdown processing
from mistletoe import Document
from mistletoe_renderer.massivewiki import MassiveWikiRenderer

def markdown_convert(markdown_text):
    with MassiveWikiRenderer(rootdir='/',wikilinks=wikifiles) as renderer:
...
def sidebar_convert_markdown(path):
    if path.exists():
        ...
        markdown_text = ''
    logging.debug("sidebar markdown text: %s", markdown_text)
